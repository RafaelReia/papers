...
the complexity of a typical IDE. %examples? DrRacket and PyCharm edu
...
to use, such as Eclipse\cite{carlson2005eclipse}, VisualStudio, Vim, Emacs. %carefull here! need help here.
...
%IDEs again?
%% %FIXME Introduce Pycharm and DrRacket?
...
%Eclipse \cite{carlson2005eclipse}, IntelliJ \cite{bock2011intellij} or NetBeans \cite{boudreau2002netbeans}
