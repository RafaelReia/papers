...
Languages used in introductory courses already have refactoring tools available, %%%%FIXME those languages, these languages ??
...
%FIXME a refactoring tool for beginners??
Such refactoring tool need to improve code made by beginners, with refactoring operations for %must help to improve / should help to improve / ?
the typical errors made, and simple enough to be used by a beginner user.
%to detect code that might/should
In addition, those tools do not provide any support for the detection of code which might or should %FIXME is that correct?
be refactored.
...
In addition, in some %FIXME improve
