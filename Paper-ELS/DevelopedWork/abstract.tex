\begin{abstract}
  ...
  simplify it or transform it to follow the style rules of the
  ...
  pedagogical IDE.  Our tool provides several refactoring operations
  for the typical mistakes made by beginners and is intended to be
  used as part of their learning process.
\end{abstract}
