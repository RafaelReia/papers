...
The major difference is the objective of the refactoring tool.
...
However, the goal of this refactoring tool is to provide refactoring operations concerned
with beginners.
...
We intend to have simple, useful, and correct for most of the cases beginners would use.
