...
\end{lstlisting} %%TODO change example to a and, or, when or unless
...
This refactoring has semantic problems if the function "foo" has collateral effects. %FIXME improve, do not like this
