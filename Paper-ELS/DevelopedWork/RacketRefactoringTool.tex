...
Instead of applying the side effect that is displaying the argument twice, in this
case displaying the string "foo", it will only display the it once.
Therefor changing the meaning of the program.

We still decided to keep this refactoring operation because in the vast majority
